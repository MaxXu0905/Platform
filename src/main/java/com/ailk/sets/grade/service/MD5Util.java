...
public class MD5Util {
	...
	protected static MessageDigest messagedigest = null; // java安全工具类
	static {
		try {
			messagedigest = MessageDigest.getInstance("MD5"); // 初始化为MD5工具类
	...
	private static String bufferToHex(byte bytes[]) { // 生成校验码
