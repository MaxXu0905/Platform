...
public class IntelligenceCategory implements Category {

	private IQbQuestionDao qbQuestionDao;

	private IGradeService gradeService;

	public IntelligenceCategory(IQbQuestionDao qbQuestionDao,
	...
	private Question fillData(QbQuestion question, int suggestTime) {
		try {
			...
			genQuestion.setChoices(response.getOptions());
			genQuestion.setaDesc(response.getOptDesc());
			return genQuestion;
		} catch (Exception e) {
			return null;
		}
