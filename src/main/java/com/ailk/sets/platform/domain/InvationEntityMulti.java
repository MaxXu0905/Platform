...
public class InvationEntityMulti implements Serializable {
...
//    private Integer paperSize; // 试卷一共包含几部分
	...
	List<InvationEntity>  perInvitationEntitys; // 必答
	private Integer perInvitationEntitysSize;
	
	List<InvationEntity>  perInvitationEntitys2; // 选答
	private Integer perInvitationEntitysSize2;
	
	List<InvationEntity>  perInvitationEntitys3;// 附加
	private Integer perInvitationEntitysSize3;
	
	
	public List<InvationEntity> getPerInvitationEntitys2()
    {
        return perInvitationEntitys2;
    }

    public void setPerInvitationEntitys2(List<InvationEntity> perInvitationEntitys2)
    {
        this.perInvitationEntitys2 = perInvitationEntitys2;
    }

    public List<InvationEntity> getPerInvitationEntitys3()
    {
        return perInvitationEntitys3;
    }

    public void setPerInvitationEntitys3(List<InvationEntity> perInvitationEntitys3)
    {
        this.perInvitationEntitys3 = perInvitationEntitys3;
    }

    
    public Integer getPerInvitationEntitysSize() {
		if(perInvitationEntitys == null)
			return 0;
		return perInvitationEntitys.size();
	}
    public Integer getPerInvitationEntitysSize2() {
        if(perInvitationEntitys2 == null)
            return 0;
        return perInvitationEntitys2.size();
    }
    public Integer getPerInvitationEntitysSize3() {
        if(perInvitationEntitys3 == null)
            return 0;
        return perInvitationEntitys3.size();
    }

	public List<InvationEntity> getPerInvitationEntitys() {
		return perInvitationEntitys;
	}

	public void setPerInvitationEntitys(List<InvationEntity> perInvitationEntitys) {
		this.perInvitationEntitys = perInvitationEntitys;
	}
